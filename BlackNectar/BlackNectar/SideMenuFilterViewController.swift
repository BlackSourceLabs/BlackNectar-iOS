...
class SideMenuFilterViewController: UITableViewController {
    ...
    @IBAction func onFarmersMarket(_ sender: Any) {
    ...
    @IBAction func applyButton(_ sender: UIButton) {
        ...
        AromaClient.beginMessage(withTitle: "Apply Button Selected")
            .addBody("Users Filter Settings: farmersMarket button is \(self.isFarmersMarket), stores button is \(self.isStore), isopenNow switch is \(self.isOpenNow)")
            .withPriority(.medium)
            .send()
